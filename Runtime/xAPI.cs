...
namespace OmiLAXR.xAPI
{
    public class xAPI
    {
        ...
        /// <returns></returns>
        public Agent CreateAgent(string name, string mail)
        {
            return new Agent
            {
        ...
        public (xAPI_Extensions_Activity, xAPI_Extensions_Context, xAPI_Extensions_Result) SplitExtensions(
        ...
        public Result CreateResult(string uri, Score score = null, bool? completion = null, bool? success = null, string response = null, xAPI_Extensions_Result extensions = null)
        {
            return new Result
            {
                score = score,
        ...
        public Statement CreateStatement(string uri, xAPI_Actor actor,
